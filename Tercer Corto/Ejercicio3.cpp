...
string bisiesto(int x){     /*Se crea una función en la que se llevará a cabo la validación de un año bisieto*/
    ...
    if (x % 4 == 0){ /*Se realizan las operaciones para comprobar si un año es bisiesto o no*/
       return a;
        ...
        return a;
    }else{       /*De loc ontrario, se presenta el mensaje de que no es año bisiesto*/
        return b;
    }
